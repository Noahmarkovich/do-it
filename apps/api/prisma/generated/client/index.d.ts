...
export namespace Prisma {
  ...
  */
   ...
   * CategoryCountOutputType without action
   */
  export type CategoryCountOutputTypeCountTasksArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: TaskWhereInput;
  };
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    user<T extends UserDefaultArgs<ExtArgs> = {}>(
      ...
      GlobalOmitOptions
    >;
    tasks<T extends Category$tasksArgs<ExtArgs> = {}>(
      args?: Subset<T, Category$tasksArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$TaskPayload<ExtArgs>,
          T,
   ...
   * Category.tasks
   */
  export type Category$tasksArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Task
  ...
  export type CategoryUpdateOneRequiredWithoutTasksNestedInput = {
    ...
    update?: XOR<
      XOR<
        CategoryUpdateToOneWithWhereWithoutTasksInput,
  ...
  export type TaskUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<
      ...
      TaskUncheckedUpdateManyWithoutUserInput
    >;
  };
  ...
  export type TaskUpdateManyWithWhereWithoutCategoryInput = {
    ...
    data: XOR<
      TaskUpdateManyMutationInput,
      TaskUncheckedUpdateManyWithoutCategoryInput
    >;
  };
